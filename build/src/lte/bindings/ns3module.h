...
typedef struct {
    PyObject_HEAD
    ns3::LteCtrlSinrChunkProcessor *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3LteCtrlSinrChunkProcessor;


extern PyTypeObject PyNs3LteCtrlSinrChunkProcessor_Type;


typedef struct {
    PyObject_HEAD
    ns3::LteDataSinrChunkProcessor *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3LteDataSinrChunkProcessor;


extern PyTypeObject PyNs3LteDataSinrChunkProcessor_Type;
...
class PythonCallbackImpl6 : public ns3::CallbackImpl<bool, ns3::Ptr<ns3::Packet>, ns3::Address const&, ns3::Address const&, unsigned short, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>
{
public:
    PyObject *m_callback;
