...
static PyMethodDef PyNs3PyViz_methods[] = {
    {(char *) "LineClipping", (PyCFunction) _wrap_PyNs3PyViz_LineClipping, METH_KEYWORDS|METH_VARARGS|METH_STATIC, NULL },
    {(char *) "Pause", (PyCFunction) _wrap_PyNs3PyViz_Pause, METH_KEYWORDS|METH_VARARGS|METH_STATIC, NULL },
    {(char *) "RegisterCsmaLikeDevice", (PyCFunction) _wrap_PyNs3PyViz_RegisterCsmaLikeDevice, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "GetPauseMessages", (PyCFunction) _wrap_PyNs3PyViz_GetPauseMessages, METH_NOARGS, NULL },
    {(char *) "GetNodesStatistics", (PyCFunction) _wrap_PyNs3PyViz_GetNodesStatistics, METH_NOARGS, NULL },
    {(char *) "GetLastPackets", (PyCFunction) _wrap_PyNs3PyViz_GetLastPackets, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "GetPacketDropSamples", (PyCFunction) _wrap_PyNs3PyViz_GetPacketDropSamples, METH_NOARGS, NULL },
    {(char *) "SimulatorRunUntil", (PyCFunction) _wrap_PyNs3PyViz_SimulatorRunUntil, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "RegisterWifiLikeDevice", (PyCFunction) _wrap_PyNs3PyViz_RegisterWifiLikeDevice, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "RegisterDropTracePath", (PyCFunction) _wrap_PyNs3PyViz_RegisterDropTracePath, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "SetPacketCaptureOptions", (PyCFunction) _wrap_PyNs3PyViz_SetPacketCaptureOptions, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "GetTransmissionSamples", (PyCFunction) _wrap_PyNs3PyViz_GetTransmissionSamples, METH_NOARGS, NULL },
    {(char *) "RegisterPointToPointLikeDevice", (PyCFunction) _wrap_PyNs3PyViz_RegisterPointToPointLikeDevice, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "SetNodesOfInterest", (PyCFunction) _wrap_PyNs3PyViz_SetNodesOfInterest, METH_KEYWORDS|METH_VARARGS, NULL },
...
initvisualizer(void)
{
    ...
    PyModule_AddObject(m, (char *) "Std__map__lt___unsigned_int__unsigned_int___gt__Iter", (PyObject *) &Pystd__map__lt___unsigned_int__unsigned_int___gt__Iter_Type);
    {
        ...
        tmp_value = PyInt_FromLong(ns3::PyViz::PACKET_CAPTURE_DISABLED);
        ...
        tmp_value = PyInt_FromLong(ns3::PyViz::PACKET_CAPTURE_FILTER_HEADERS_OR);
        ...
        tmp_value = PyInt_FromLong(ns3::PyViz::PACKET_CAPTURE_FILTER_HEADERS_AND);
