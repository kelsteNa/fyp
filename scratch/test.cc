...
*/
	...
	Ipv4stat->SetDefaultRoute("10.1.2.3",1,-10);
	...
	Ipv4stat2->SetDefaultRoute("10.1.2.3",1,-10);
...
*/ 
	Ptr<Node> t_node3 = gatewayNode.Get(0);
	Ipv4StaticRoutingHelper helper3;
	Ptr<Ipv4> ipv43 = t_node3->GetObject<Ipv4>();
	Ptr<Ipv4StaticRouting> Ipv4stat3 = helper3.GetStaticRouting(ipv43);
	//Ipv4stat3->SetDefaultRoute("10.1.1.1",1,-10);
	Ipv4stat3->AddHostRouteTo("10.1.2.1", "10.1.2.1", 0, 0);
...
*/
	...
	ApplicationContainer serverApps1 = echoServer1.Install (gatewayNode.Get (0));
